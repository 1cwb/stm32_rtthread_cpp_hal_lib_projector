...
private:
    inline void imuQuaternionComputeProducts(const quaternion_t& quat, quaternionProducts& quatProd);
    ...
    float imuCalcKpGain(uint64_t currentTimeUs, bool useAcc, const std::array<float, 3>& gyroAverage);
