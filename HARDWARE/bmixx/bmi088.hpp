...
class Bmi088Accel {
  public:
    ...
    Bmi088Accel(mDev::mI2c& bus, uint8_t address);
    Bmi088Accel(mDev::mSpi& bus, mDev::mGpio& csPin);
    int begin();
    bool setOdr(Odr odr);
...
class Bmi088Gyro {
  public:
    ...
    Bmi088Gyro(mDev::mI2c &bus,uint8_t address);
    Bmi088Gyro(mDev::mSpi &bus,mDev::mGpio& csPin);
    int begin();
    bool setOdr(Odr odr);
    bool setRange(Range range);
...
class Bmi088 : public mDev::mImu{
  public:
    ...
    Bmi088(const char* name, mDev::mI2c &bus,uint8_t accel_addr,uint8_t gyro_addr);
