...
extern "C" void DMA1_Stream0_IRQHandler(void)
{
  ...
  mDev::mUsart* p = ((mDev::mUsart*)mDev::mPlatform::getInstance()->getDevice("usart1"));
  if(p)
  {
    HAL_DMA_IRQHandler(((usart*)(p->getObj()))->dmaTxHandle());
  }
...
extern "C" void DMA1_Stream1_IRQHandler(void)
{
  ...
  if(p)
  {
    HAL_DMA_IRQHandler(((usart*)(p->getObj()))->dmaRxHandle());
  }
...
extern "C" void USART1_IRQHandler(void)
{
  ...
  if(p)
  {
        HAL_UART_IRQHandler(((usart*)(p->getObj()))->usartHandle());
  }
